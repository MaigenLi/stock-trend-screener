...
LOG_DIR="/home/lyc/.openclaw/workspace/stock_reports/log"
...
${PYTHON} ${WORKSPACE}/review_screen/screen_double.py --date ${DATE} --top-n 250 >> ${LOG_DIR}/screen_double.log 2>&1
