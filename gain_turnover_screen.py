...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-gain", type=float, default=10.0, help="每日涨幅最大值%%")
    ...
    parser.add_argument("--score-threshold", type=float, default=40.0, help="评分门槛（默认40.0）")
    ...
    parser.add_argument("--check-volume-surge", action="store_true", help="开启质量窗口放量检查（默认关闭，采用true_turnover）。近days日均换手率>=前days日均×1.30")
